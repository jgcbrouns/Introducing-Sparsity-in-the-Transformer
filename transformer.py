...
class EncoderLayer():
	def __init__(self, d_model, d_inner_hid, n_head, d_k, d_v, dropout=0.1, layer_number = 0, weightsForSparsity=None):
		self.self_att_layer = MultiHeadAttention(n_head, d_model, d_k, d_v, dropout=dropout, layer_number=layer_number, weightsForSparsity=weightsForSparsity)
...
class Encoder():
	def __init__(self, d_model, d_inner_hid, n_head, d_k, d_v, \
				layers=6, dropout=0.1, word_emb=None, pos_emb=None, weightsForSparsity=None):
		self.emb_layer = word_emb
		self.pos_layer = pos_emb
		self.emb_dropout = Dropout(dropout)
		self.layers = [EncoderLayer(d_model, d_inner_hid, n_head, d_k, d_v, dropout, layer_number, weightsForSparsity=weightsForSparsity) for layer_number, x in enumerate(range(layers))]
...
class Transformer:
	...
	def __init__(self, i_tokens, o_tokens, len_limit, d_model=256, \
			  ...
			  share_word_emb=False, weightsForSparsity=None):
		...
		self.encoder = Encoder(d_model, d_inner_hid, n_head, d_k, d_v, layers, dropout, \
							word_emb=i_word_emb, pos_emb=pos_emb, weightsForSparsity=weightsForSparsity)
